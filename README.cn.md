...
[![x-cmd/install — CMake Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/CMake.svg?lang=zh)](https://x-cmd.com/install/CMake)
...
合计: **1,264,301** 行代码（覆盖前 5 种语言、共 **19923** 个文件）。
...
- **官网**: <https://gitlab.kitware.com/cmake/cmake>
- **许可证**: BSD-3-Clause
...
- **Star**: 8,097 · **Fork**: 2,705 · **开放 issue**: 0 · **贡献者**: 1,518

## 累计统计

- **发布数**: 332 · **已合并 PR**: 0 · **开放 PR**: 0 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 77365
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/CMake.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T04:44:53Z._
